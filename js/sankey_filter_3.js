        ...
        function mergeAlikeLinks(){
            ...
            links.forEach(function(linkFirst,firstIndex){
                ...
                // tempLinks.forEach(function(linkSecond,secondIndex){
                //    if(secondIndex > firstIndex){
                //         if(isLinkAlike(linkFirst,linkSecond)){
                //             console.log(linkFirst,linkSecond);
                //             debugger;
                //             linkFirst.value = linkFirst.value + linkSecond.value;
                //             console.log(linkFirst);
                //             console.log(links,secondIndex,firstIndex);
                //             debugger;
                //             tempLinks.splice(secondIndex,1);
                //             var removed = links.splice(secondIndex,1);
                //             console.log(removed);
                //             debugger;
                //         }
                //    }
